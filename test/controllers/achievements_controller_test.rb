...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { achievement: @achievement.achievement, captain: @achievement.captain, gender: @achievement.gender, player_name: @achievement.player_name, sport_name: @achievement.sport_name } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { achievement: @achievement.achievement, captain: @achievement.captain, gender: @achievement.gender, player_name: @achievement.player_name, sport_name: @achievement.sport_name } }
