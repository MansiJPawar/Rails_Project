...
class SportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sport" do
    assert_difference('Sport.count') do
      post sports_url, params: { sport: { sport_equipement: @sport.sport_equipement, sport_name: @sport.sport_name, user_id: @sport.user_id } }
    end
  ...
  test "should update sport" do
    patch sport_url(@sport), params: { sport: { sport_equipement: @sport.sport_equipement, sport_name: @sport.sport_name, user_id: @sport.user_id } }
