...
class AnnouncementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create announcement" do
    assert_difference('Announcement.count') do
      post announcements_url, params: { announcement: { announcement_title: @announcement.announcement_title, content: @announcement.content, user_id: @announcement.user_id } }
    end
  ...
  test "should update announcement" do
    patch announcement_url(@announcement), params: { announcement: { announcement_title: @announcement.announcement_title, content: @announcement.content, user_id: @announcement.user_id } }
